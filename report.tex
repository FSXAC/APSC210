...
\\
For the scope of this report, I will explore the latter industry for a mix of both hardware and low level software/firmware. This falls under the sector outlined on the Co-op handbook\cite{coop-handbook} manufacturing and services sectors; namely ``Computer/Electrical/Electronic Machinary/Equipment" and ``Computer Related Services/Hardware".\\
\\
\subsection{Industry History}

% TODO:

The electrical machinary equipment industry has been relevant since the industrial revolution while the computer hardware industry emerged after the world wars as they become more applicable to consumers.\\
\\
